...
//** instagram slider **//
  ...
  $('.user-dropdown-open').slideUp();
  $('.user-dropdown-click').on('click', function () {
    $('.user-dropdown-open').slideToggle()
  });
  ...
  // header scroll show when window scroll down
  ...
  $('.not-show-offer').on('click', function (e) {
    $(".none-address").slideToggle();
    $(".more-offer").fadeToggle();
    $(".less-offer").fadeToggle();
  });
  ...
  $('.list-layout-view').on('click', function (e) {
    ...
    $(".product_wrapper_description").css("display", "block");
    $(".search_product_detail").css("width", "50%");
  ...
  $('.grid-layout-view').on('click', function (e) {
    ...
    $(".product_wrapper_description").css("display", "none");
    $(".search_product_detail").css("width", "100%");
...
/** to top of windows**/
  ...
  body_event.on("click", ".color1", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color1.css");
    return false;

  });
  body_event.on("click", ".color2", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color2.css");
    return false;
  });
  body_event.on("click", ".color3", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color3.css");
    return false;
  });
  body_event.on("click", ".color4", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color4.css");
    return false;
  });
  body_event.on("click", ".color5", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color5.css");
    return false;
  });
  body_event.on("click", ".color6", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color6.css");
    return false;
  });
  body_event.on("click", ".color7", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color7.css");
    return false;
  });
  body_event.on("click", ".color8", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color8.css");
    return false;
  });
  body_event.on("click", ".color9", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color9.css");
    return false;
  });
  body_event.on("click", ".color10", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color10.css");
    return false;
  });
  body_event.on("click", ".color11", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color11.css");
    return false;
  });
  body_event.on("click", ".color12", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color12.css");
    return false;
  });
  body_event.on("click", ".color13", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color13.css");
    return false;
  });
  body_event.on("click", ".color14", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color14.css");
    return false;
  });
  body_event.on("click", ".color15", function () {
    $("#color").attr("href", "http://127.0.0.1:8000/bigdeal/assets/css/color15.css");
    return false;
  });
...
// Morteza Jaladats code //

function like(event, id) {
    event.preventDefault();
  document.getElementById('addLike-' + id).submit();
}
function cart(event, id) {
    event.preventDefault();
  document.getElementById('addCart-' + id).submit();
}

function openWishlistAlert()
{
    Swal.fire({
        title: 'شما هنوز وارد پنل خود نشده اید دوست دارید وارد شوید؟',
        icon: 'info',
...
function recaptcha(event)
{
  event.preventDefault();
 var a = Math.floor((Math.random() * 10) + 1);
 var b = Math.floor((Math.random() * 10) + 1);
  document.getElementById("random_input_a").value = a;
  document.getElementById("random_input_b").value = b;
}


function quantityPlus(event, id) {
  event.preventDefault();
  document.getElementById('quantityPlus-' + id).submit();
}
function quantityMinus(event, id) {
  event.preventDefault();
  document.getElementById('quantityMinus-' + id).submit();
}
function deleteCart(event, id) {
  event.preventDefault();
  document.getElementById('deleteCart-' + id).submit();
}
