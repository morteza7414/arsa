...
<div class="loader-wrapper">
    <div>
        <img src="{{asset('bigdeal/assets/images/loader.gif')}}" alt="loader">
    </div>
</div>
<!-- loader end -->
                ...
                <div class="col-12">
                    <div class="navbar-menu">
                        <div class="logo-block">
                            <div class="brand-logo logo-sm-center">
                                <a href="index.html">
                                    <img src="{{asset('bigdeal/assets/images/layout-2/logo/logo.png')}}"
                                ...
                                <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                                    <ul class="nav-cat title-font">
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/01.png')}}"
                                                        alt="category-product">لباس گرم</a></li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/02.png')}}"
                                                        alt="category-product">تلویزیون</a>
                                        </li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/03.png')}}"
                                                        alt="category-product">حیوانات خانگی</a>
                                        </li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/04.png')}}"
                                                        alt="category-product"> ماشین، موتور
                                                سیکلت</a>
                                        </li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/05.png')}}"
                                                        alt="category-product"> محصولات صنعتی</a>
                                        </li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/06.png')}}"
                                                        alt="category-product">محصولات زیبایی و
                                                سلامت</a></li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/07.png')}}"
                                                        alt="category-product"> آجیل و خشکبار </a>
                                        </li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/08.png')}}"
                                                        alt="category-product"> ورزشی</a></li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/09.png')}}"
                                                        alt="category-product"> کیف و کفش</a>
                                        </li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/10.png')}}"
                                                        alt="category-product"> فیلم و موسیقی </a>
                                        </li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/11.png')}}"
                                                        alt="category-product"> کنسول بازی</a></li>
                                        <li><a href="category-page(left-sidebar).html"><img
                                                        src="{{asset('bigdeal/assets/images/layout-1/nav-img/12.png')}}"
                                            ...
                                            <li>
                                                <div class="container">
                                                    ...
                                                    <div class="row menu-banner">
                                                        <div class="col-lg-6">
                                                            <div>
                                                                <img src="{{asset('bigdeal/assets/images/menu-banner1.jpg')}}"
                                                                     alt="menu-banner" class="img-fluid">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div>
                                                                <img src="{{asset('bigdeal/assets/images/menu-banner2.jpg')}}"
                                                                     alt="menu-banner" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col mega-box product ">
                                                            <div class="mega-img">
                                                                <img src="{{asset('bigdeal/assets/images/mega-banner.jpg')}}"
                                                                     alt="menu-banner" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="{{asset('bigdeal/invoice-template/element-invoice.html')}}">فاکتور
                                                            یک</a></li>
                                                    <li>
                                                        <a href="{{asset('bigdeal/invoice-template/element-invoice2.html')}}">فاکتور
                                                            دو</a></li>
                                                    <li>
                                                        <a href="{{asset('bigdeal/invoice-template/element-invoice3.html')}}">فاکتور
                                                            سه</a></li>
                                                    <li>
                                                        <a href="{{asset('bigdeal/invoice-template/element-invoice4.html')}}">فاکتور
                                                            چهار</a></li>
                                                    <li>
                                                        <a href="{{asset('bigdeal/invoice-template/element-invoice5.html')}}">فاکتور
                                                            پنج</a></li>
                                                </ul>
                                            </li>
                                            <li>
                             ...
                             M451.001,482H451H61v-71.363C96.031,360.683,152.952,331,214.167,331h83.667c61.215,0,118.135,29.683,153.167,79.637V482z"/>
                                ...
                                <li class="mobile-wishlist item-count" onclick="openWishlist()">
                                    <a href="javascript:void(0)">
                                        ...
                                        <div class="cart-item">
                                            <div> {{auth()->user()->likeCount()}} مورد<span>لیست علاقه مندی</span>
                                            </div>
                                        </div>
                                        <div class="item-count-contain">
                                            {{auth()->user()->likeCount()}}
                        ...
                        <div class="category-right">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu gift-dropdown">
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('bigdeal/assets/images/icon/1.png')}}"
                                                 alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-0">روزهای شگفت انگیز</h5>
                                            <p><img src="{{asset('bigdeal/assets/images/icon/currency.png')}}"
                                                    class="cash" alt="curancy"> بیش از 270 جایزه
                                            </p>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('bigdeal/assets/images/icon/2.png')}}"
                                                 alt="Generic placeholder image" class="gift-bloc">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-0">تخفیف مُد</h5>
                                            <p><img src="{{asset('bigdeal/assets/images/icon/fire.png')}}" class="fire"
                                                    alt="fire">10 در صد تخفیف بیشتر (تا
                                                سقف 100 هزار تومان) </p>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('bigdeal/assets/images/icon/3.png')}}"
                                                 alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('bigdeal/assets/images/icon/6.png')}}"
                                                 alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('bigdeal/assets/images/icon/5.png')}}"
                                                 alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                            ...
                            <div class="footer-contant">
                                ...
                                <ul class="paymant">
                                    <li><a href="javascript:void(0)"><img
                                                    src="{{asset('bigdeal/assets/images/layout-1/pay/1.png')}}"
                                                    class="img-fluid"
                                                    alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img
                                                    src="{{asset('bigdeal/assets/images/layout-1/pay/2.png')}}"
                                                    class="img-fluid"
                                                    alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img
                                                    src="{{asset('bigdeal/assets/images/layout-1/pay/3.png')}}"
                                                    class="img-fluid"
                                                    alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img
                                                    src="{{asset('bigdeal/assets/images/layout-1/pay/4.png')}}"
                                                    class="img-fluid"
                                                    alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img
                                                    src="{{asset('bigdeal/assets/images/layout-1/pay/5.png')}}"
                                                    class="img-fluid"
                                                    alt="pay"></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="modal-bg">
                        <div class="newslatter-main">
                            ...
                            <div class="imd-wrraper">
                                <img src="{{asset('bigdeal/assets/images/subscribe/1.jpg')}}" alt="newsletterimg"
    ...
    <div class="cart-inner">
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="{{asset('bigdeal/html/product-page(left-sidebar).html')}}">
                            <img alt="megastore1" class="me-3"
                                 src="{{asset('bigdeal/assets/images/layout-2/product/1.jpg')}}">
                        </a>
                        <div class="media-body">
                            <a href="{{asset('bigdeal/html/product-page(left-sidebar).html')}}">
                                <h4>گوشی هوشمند</h4>
                ...
                <li>
                    <div class="media">
                        <a href="product-page(left-sidebar).html">
                            <img alt="megastore1" class="me-3"
                                 src="{{asset('bigdeal/assets/images/layout-2/product/2.jpg')}}">
                        </a>
                        <div class="media-body">
                            <a href="product-page(left-sidebar).html">
                                <h4>یخچال دو در</h4>
                ...
                <li>
                    <div class="media">
                        <a href="{{asset('bigdeal/html/product-page(left-sidebar).html')}}">
                            <img alt="megastore1" class="me-3"
                                 src="{{asset('bigdeal/assets/images/layout-2/product/3.jpg')}}">
                        </a>
                        <div class="media-body">
                            <a href="{{asset('bigdeal/html/product-page(left-sidebar).html')}}">
                                <h4>کیف زنانه</h4>
            ...
            <ul class="cart_total">
                ...
                <li>
                    <div class="buttons">
                        <a href="{{asset('bigdeal/html/cart.html')}}" class="btn btn-solid btn-sm">سبد خرید</a>
                        <a href="{{asset('bigdeal/html/checkout.html')}}" class="btn btn-solid btn-sm ">پرداخت</a>
                    </div>
                </li>
            </ul>
        </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="addit-box">
                                    ...
                                    <div class="pro-add">
                                        <span>حذف:</span>
                                        <a onclick="like(event,{{$like['id']}})" href="javascript:void(0)">
                                            <i data-feather="trash-2"></i>
                                        </a>
                                    </div>
