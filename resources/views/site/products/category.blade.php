                    ...
                    <div class="breadcrumb-contain">
                        <div>
                            ...
                            <ul>
                                ...
                                <li><a href="javascript:void(0)">دسته بندی</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="top-banner-wrapper">
                                        ...
                                        <div class="category-header-title top-banner-content small-section">
                                            ...
                                            <div class="price_filter_message">
                                                @if($from === 'nothing' and $to === 'nothing')

                                                @elseif($from !== 'nothing' and $to === 'nothing')
                                                    <div class="inline_flex">
                                                        <h5>
                                                            فیلتر قیمت:
                                                        </h5>
                                                        شروع قیمت از
                                                        <span class="color-1 price_filter_price">
                                                            {{$from}}
                                                        </span>
                                                    </div>
                                                @elseif($from === 'nothing' and $to !== 'nothing')
                                                    ...
                                                    <div class="col-12 position-relative">
                                                        <div class="product-filter-content horizontal-filter-mian ">
                                                            ...
                                                            <div class="filter_price">
                                                                <form action="{{route('category',$title)}}">
                                                            ...
                                                            <div class="product-detail detail-center detail-inverse search_product_detail">
                                                                <div class="detail-title">
                                                                    ...
                                                                    <div class="detail-right">
                                                                        @if($product['amazing_price'])
                                                                            <div class="check-price">
                                                                                {{$product['price']}} تومان
                                                                            </div>
                                                                            <div class="price">
                                                                                <div class="price">
                                                                                    {{$product['amazing_price']}} تومان
                                                                                </div>
                                                                            </div>
                                                                        @elseif($product['offprice'] and empty($product['amazing_price']))
                                                                            <div class="check-price">
                                                                                {{$product['price']}} تومان
                                                                            </div>
                                                                            <div class="price">
